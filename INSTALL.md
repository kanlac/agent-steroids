...
|---|---|---|---|
| Claude Code | `steroids` | `chrome`, `telegram` | 无 |
| Codex | `steroids` | `chrome` | `telegram` |
| Hermes | `agent-steroids/steroids` | `agent-steroids/chrome` | `agent-steroids/telegram` |
...
3. 如安装 `chrome`，继续根据 `plugins/chrome/skills/cdp-chrome/SKILL.md` 完成 Chrome/CDP 或 MCP 配置。
