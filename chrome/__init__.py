"""Hermes plugin shim for the Agent Steroids chrome plugin.
...
``agent-steroids/chrome``.  The canonical cross-runtime skills stay under
``plugins/chrome/skills`` for Claude Code and Codex compatibility.
"""
...
def register(ctx) -> None:
    ...
    skills_dir = repo_root / "plugins" / "chrome" / "skills"
