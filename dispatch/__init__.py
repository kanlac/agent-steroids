"""Hermes plugin shim for the Agent Steroids dispatch plugin.
...
``agent-steroids/dispatch``. The canonical cross-runtime skills stay under
``plugins/dispatch/skills`` for Claude Code and Codex compatibility.
"""
...
def register(ctx) -> None:
    ...
    skills_dir = repo_root / "plugins" / "dispatch" / "skills"
