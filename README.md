...
| [`dispatch`](plugins/steroids/skills/dispatch/SKILL.md) | `steroids` | 把活派给别的模型的 CLI（Codex 跑 GPT，OpenCode 跑 GLM/DeepSeek/Kimi）：怎么写任务、这些 CLI 有哪些提示词里看不见的硬边、怎么审收回来的产物。 |
